...
1. **Login First**: Make sure you're logged into [forevermamba.work](https://forevermamba.work) in your browser
...
- Active login session on forevermamba.work
- Internet connection
...
- Open [forevermamba.work](https://forevermamba.work) and log in with GitHub
...
- This extension only communicates with forevermamba.work
